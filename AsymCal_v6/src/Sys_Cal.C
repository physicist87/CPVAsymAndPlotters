...
void Sys_Cal()
{
   string channels[4]={"dimuon","dielec","muonelec","dileptonic"};
   string Channels[4]={"MuMu","ElEl","MuEl","DiLep"};
   ...
   /// Central ///
   ifstream central_input[4][13];
   Double_t central[4][13], central_errp[4][13], central_errm[4][13];
   ...
   /// LeptonID /// 
   ifstream lepid_input[4][13][2]; //[ch][vari]
   string lepid_name[2]={"LepIDUp","LepIDDown"}; 
   Double_t lepid_sys[4][13][2], lepid_errp[4][13][2], lepid_errm[4][13][2];//[ch][vari][up&down]
   /// Initialize array for Central Value ///
   for (int i = 0; i < 4; ++i)
   {
      for (int j = 0; j < 13; ++j)
   ...
   /// LeptonIso /// 
   ifstream lepiso_input[4][13][2]; //[ch][vari]
   string lepiso_name[2]={"LepIsoUp","LepIsoDown"}; 
   Double_t lepiso_sys[4][13][2], lepiso_errp[4][13][2], lepiso_errm[4][13][2];//[ch][vari][up&down]
   /// Initialize array for Central Value ///
   for (int i = 0; i < 4; ++i)
   {
      for (int j = 0; j < 13; ++j)
   ...
   /// JES  /// 
   ifstream jes_input[4][13][2]; //[ch][vari]
   string jes_name[2]={"JetEnUp","JetEnDown"}; 
   Double_t jes_sys[4][13][2], jes_errp[4][13][2], jes_errm[4][13][2];//[ch][vari][up&down]
   /// Initialize array for Central Value ///
   for (int i = 0; i < 4; ++i)
   {
      for (int j = 0; j < 13; ++j)
   ...
   /// BTagEff /// 
   ifstream btageff_input[4][13][2]; //[ch][vari]
   string btageff_name[2]={"BTagEffUp","BTagEffDown"}; 
   Double_t btageff_sys[4][13][2], btageff_errp[4][13][2], btageff_errm[4][13][2];//[ch][vari][up&down]
   /// Initialize array for Central Value ///
   for (int i = 0; i < 4; ++i)
   {
      for (int j = 0; j < 13; ++j)
   ...
   /// BTagSF /// 
   ifstream btagsf_input[4][13][2]; //[ch][vari]
   string btagsf_name[2]={"BTagSFUp","BTagSFDown"}; 
   Double_t btagsf_sys[4][13][2], btagsf_errp[4][13][2], btagsf_errm[4][13][2];//[ch][vari][up&down]
   /// Initialize array for Central Value ///
   for (int i = 0; i < 4; ++i)
   {
      for (int j = 0; j < 13; ++j)
   ...
   /// PileUp /// 
   ifstream pileup_input[4][13][2]; //[ch][vari]
   string pileup_name[2]={"PileUpUp","PileUpDown"}; 
   Double_t pileup_sys[4][13][2], pileup_errp[4][13][2], pileup_errm[4][13][2];//[ch][vari][up&down]
   /// Initialize array for Central Value ///
   for (int i = 0; i < 4; ++i)
   {
      for (int j = 0; j < 13; ++j)
...
/*   /// LepTrack /// 
   ifstream leptrack_input[4][13][2]; //[ch][vari]
   string leptrack_name[2]={"LepTrackUp","LepTrackDown"}; 
   Double_t leptrack[4][13][2], leptrack_errp[4][13][2], leptrack_errm[4][13][2];//[ch][vari][up&down]
   /// Initialize array for Central Value ///
   for (int i = 0; i < 3; ++i)
   {
      for (int j = 0; j < 13; ++j)
   ...
   /// LepReco /// 
   ifstream lepreco_input[4][13][2]; //[ch][vari]
   string lepreco_name[2]={"LepRecoUp","LepRecoDown"}; 
   Double_t lepreco[4][13][2], lepreco_errp[4][13][2], lepreco_errm[4][13][2];//[ch][vari][up&down]
   /// Initialize array for Central Value ///
   for (int i = 0; i < 3; ++i)
   {
      for (int j = 0; j < 13; ++j)
...
*/
   ...
   //////////////////////////////////
   Double_t sys_uncern_lepid[4][13][2];
   for (int i = 0; i < 4; ++i)
   {
      for (int j = 0; j < 13; ++j)
      {
   ...
   /// LepIso ///
   Double_t sys_uncern_lepiso[4][13][2];
   for (int i = 0; i < 3; ++i)
   {
      for (int j = 0; j < 13; ++j)
      {
   ...
   /// JES ///
   Double_t sys_uncern_jes[4][13][2];
   for (int i = 0; i < 4; ++i)
   {
      for (int j = 0; j < 13; ++j)
      {
   ...
   /// BTagEff ///
   Double_t sys_uncern_btageff[4][13][2];
   for (int i = 0; i < 3; ++i)
   {
      for (int j = 0; j < 13; ++j)
      {
   ...
   /// BTagSf ///
   Double_t sys_uncern_btagsf[4][13][2];
   for (int i = 0; i < 4; ++i)
   {
      for (int j = 0; j < 13; ++j)
      {
   ...
   /// PileUp ///
   Double_t sys_uncern_pileup[4][13][2];
   for (int i = 0; i < 4; ++i)
   {
      for (int j = 0; j < 13; ++j)
      {
